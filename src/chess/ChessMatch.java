...
public class ChessMatch {
	...
	private void validateTargetPosition(Position source, Position target) {
		...
		if(!board.piece(source).possibleMove(target)) {
			throw new ChessException("A peca escolhida [origem] NAO PODE SE MOVER para a posicao escolhida [destino]");
		}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Nao existe peca King na cor [" + color + "] no tabuleiro!" );
	}
